  ...
  return (
    <main className="flex min-h-screen flex-col overflow-hidden scroll-smooth pt-[75px] bg-[#F8F8F8] z-10">
      <section className="w-full relative justify-center flex">
        <div className="w-full bg-red-500 h-[850px] bg-[url(/img-landingpage.jpg)] bg-cover relative flex justify-center items-center max-lg:items-start">
          ...
          <div className="z-20 flex gap-8 justify-center max-lg:flex-col max-w-7xl w-full p-8">
            <div className="flex flex-col items-end w-fit gap-4">
              <h1 className="font-extrabold text-right text-7xl text-white w-[500px] max-lg:w-full max-lg:text-center max-lg:text-3xl">VAMOS CONSTUIR SUA PISCINA!</h1>
